...
export const bottomButtons = document.getElementById(
  'bottom-buttons'
) as HTMLElement
export const purchaseMainTowerButton = document.getElementById(
  'purchase-main-tower'
) as HTMLButtonElement
export const purchaseWaterTowerButton = document.getElementById(
  'purchase-water-tower'
) as HTMLButtonElement
export const purchaseFireTowerButton = document.getElementById(
  'purchase-fire-tower'
) as HTMLButtonElement
export const purchaseEarthTowerButton = document.getElementById(
  'purchase-earth-tower'
) as HTMLButtonElement
export const purchaseAirTowerButton = document.getElementById(
  'purchase-air-tower'
) as HTMLButtonElement
export const purchaseCoinsButton = document.getElementById(
  'purchase-coins'
) as HTMLButtonElement
export const startLevelButton = document.getElementById(
  'start-level-button'
) as HTMLButtonElement

export const bottomInfo = document.getElementById(
  'bottom-info'
) as HTMLDivElement
export const levelDisplay = document.getElementById(
  'level-display'
...
export function updateShop(game: Game) {
  ...
  if (coins >= costs[AllyType.WATER]) {
    ...
    purchaseWaterTowerButton.onclick = () =>
      toggleTowerInfo(!!allies.water ? allies.water : AllyType.WATER)
  } else purchaseWaterTowerButton.disabled = true
  if (coins >= costs[AllyType.FIRE]) {
    purchaseFireTowerButton.disabled = false
    purchaseFireTowerButton.onclick = () =>
      toggleTowerInfo(!!allies.fire ? allies.fire : AllyType.FIRE)
  } else purchaseFireTowerButton.disabled = true
  if (coins >= costs[AllyType.EARTH]) {
    purchaseEarthTowerButton.disabled = false
    purchaseEarthTowerButton.onclick = () =>
      toggleTowerInfo(!!allies.earth ? allies.earth : AllyType.EARTH)
  } else purchaseEarthTowerButton.disabled = true
  if (coins >= costs[AllyType.AIR]) {
    purchaseAirTowerButton.disabled = false
    purchaseAirTowerButton.onclick = () =>
      toggleTowerInfo(!!allies.air ? allies.air : AllyType.AIR)
  } else purchaseAirTowerButton.disabled = true
}

export const shop = document.getElementById('shop') as HTMLElement
export const shopButton = document.getElementById(
  'shop-button'
) as HTMLButtonElement
export const closeShopButton = document.getElementById(
  'close-shop-button'
) as HTMLButtonElement
